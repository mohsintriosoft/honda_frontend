...
export default function CampaignDetailPage() {
  ...
  const funnel = [
    {
      stage: "Customers",
      value: c.totals.customers,
    },
    {
      stage: "Completed",
      value: c.totals.completed,
    },
    {
      stage: "Connected",
      value: c.totals.connected,
    },
    {
      stage: "Interested",
      value: c.totals.interested,
    },
    {
      stage: "Booked",
      value: c.totals.booked,
    },
  ];
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="rounded-md border bg-card p-3">
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  11:00–12:30 — connect rate is 22% higher than average.
                </div>
              </div>
              ...
              <div className="rounded-md border bg-card p-3">
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  14 customers asked for price and ended call. Consider proactive pricing in script.
                </div>
              </div>
            </CardContent>
          </Card>
