          ...
          <TabsContent value="upload" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Drop a whole folder exported from your dialer. Each file is transcribed and tagged
                  automatically.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-3">
                <IngestDropzone
                  onFiles={(files) => addUploads(files, "upload", `${files.length} files uploaded`)}
                />
                ...
                <UploadModuleMapping
                  ...
                  sampleFiles={[
                    {
                      name: "OMH_SERVICE_1042.mp3",
                      parsed: "Service",
                    },
                    {
                      name: "OMH_INSURANCE_2210.mp3",
                      parsed: "Insurance",
                    },
                    {
                      name: "call_20260714_0931.mp3",
                      parsed: null,
                    },
                  ]}
                />
                ...
                <p className="text-xs text-muted-foreground">
                  Language auto-detects Bhopali Hindi / Hinglish. Anything the pattern can't tag
                  falls back to{" "}
                  {fallback === "ai"
                    ? "the transcript classifier"
                    : "the Needs-classification queue"}{" "}
                  and can always be corrected in the library.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="manifest" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  ZIP of audio, or a CSV of recording URLs plus metadata.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                <IngestDropzone
                  ...
                  onFiles={(files) =>
                    addUploads(files, "manifest", files[0]?.name ?? "manifest import")
                  }
                />
                ...
                <div className="rounded-lg border">
                  ...
                  <div className="border-t px-3 py-2 text-xs text-muted-foreground">
                    <span className="text-destructive">*</span> required — rows with a missing or
                    unknown <span className="font-mono">module</span> value are flagged in the
                    preview and routed by the fallback rule.
          ...
          <TabsContent value="dialer" className="mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Pull recordings automatically from your telephony provider.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-xs text-muted-foreground">
                    Last sync: today 09:12 • 612 recordings pulled
                  </span>
                </div>
              </CardContent>
            </Card>
